...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl w100" name="name" value="',htmlspecialchars($options['name']),'" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl w200" name="main_nodes" value="',$options['main_nodes'],'" /> 默认留空，发新帖时可选的主分类id，用逗号隔开</td>
    </tr>
    <tr>
